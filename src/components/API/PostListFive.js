...
export class PostListFive extends Component {
    render() {
        ...
        async function getStudentInfo() {
            ...
            const { city: cityTwenty, company: companyTwenty, email: emailTwenty, firstName: firstNameTwenty, lastName: lastNameTwenty, skill: skillTwenty } = students[20]
            const { city: cityTwentyOne, company: companyTwentyOne, email: emailTwentyOne, firstName: firstNameTwentyOne, lastName: lastNameTwentyOne, skill: skillTwentyOne } = students[21]
            const { city: cityTwentyTwo, company: companyTwentyTwo, email: emailTwentyTwo, firstName: firstNameTwentyTwo, lastName: lastNameTwentyTwo, skill: skillTwentyTwo } = students[22]
            const { city: cityTwentyThree, company: companyTwentyThree, email: emailTwentyThree, firstName: firstNameTwentyThree, lastName: lastNameTwentyThree, skill: skillTwentyThree } = students[23]
            const { city: cityTwentyFour, company: companyTwentyFour, email: emailTwentyFour, firstName: firstNameTwentyFour, lastName: lastNameTwentyFour, skill: skillTwentyFour } = students[24]
        ...
        return (
            <div>
                ...
                <div className='student-block-one'>
                    <div className='student-image-border'>
                        <img className='student-image' src='https://storage.googleapis.com/hatchways-app.appspot.com/assessments/data/frontend/images/delenitiestdolorum.jpg'></img><br />
                    </div>
                ...
                <div className='student-block-one'>
                    <div className='student-image-border'>
                        <img className='student-image' src='https://storage.googleapis.com/hatchways-app.appspot.com/assessments/data/frontend/images/sitlaborecorrupti.jpg'></img><br />
                    </div>
