...
export class PostListFour extends Component {
    render() {
        ...
        async function getStudentInfo() {
            ...
            const { city: cityEightteen, company: companyEightteen, email: emailEightteen, firstName: firstNameEightteen, id: idEightteen, lastName: lastNameEightteen, skill: skillEightteen } = students[18]
            ...
            document.getElementById('id-name-fifteen').textContent = idFifteen;
            ...
            document.getElementById('id-name-sixteen').textContent = idSixteen;
            ...
            document.getElementById('id-name-seventeen').textContent = idSeventeen;
            ...
            document.getElementById('id-name-eightteen').textContent = idEightteen;
            ...
            document.getElementById('id-name-nineteen').textContent = idNineteen;
        ...
        return (
            <div>
                ...
                <div className='student-block'>
                    ...
                    <span id='id-name-seventeen'></span>
                    <h1>
                ...
                <div className='student-block'>
                    <img src='https://storage.googleapis.com/hatchways-app.appspot.com/assessments/data/frontend/images/remtemporavelit.jpg'></img><br />
                    <span id='id-name-eightteen'></span>
                    <h1>
